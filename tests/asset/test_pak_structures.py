...
合并自：
- tests/asset/test_pak_structures.py — FPakEntry bitfield 编解码 + FPakInfo 序列化大小
- tests/pak/test_pak_structures.py — 索引解析、FPakEntry 布局、解压炸弹
- tests/pak/test_security_integration.py — Pak 解压安全集成
"""
...
class TestDecompressionBombIntegration:
    """解压炸弹防护集成测试。"""
...
# === 合并自 test_pak_decompress_validation.py ===
"""Pak 解压缩块校验回归测试"""
