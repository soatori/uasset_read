"""Asset 核心测试 — PAK/IoStore 结构与解压。

合并自：
- test_pak_structures.py — FPakEntry bitfield 编解码、FPakInfo 序列化、索引解析、解压炸弹
- test_pak_handling.py — decompress_entry 安全检查、PakFileReader、IoStore 分区读取、原始文件解析
"""
