"""Blueprint 核心测试（blueprint/core）。

合并自：
- test_blueprint_field_validation.py — 接口、描述、变量类型、FText Category、构造函数元数据
- test_blueprint_node_cleaner.py — BlueprintNodeCleaner C++ 语义映射
"""
