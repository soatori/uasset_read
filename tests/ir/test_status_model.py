...
class TestBuildIrHeuristicStatus:
    ...
    def test_decompiled_function_warnings_aggregated(self):
        """decompiled function 的 warnings 应聚合到 PackageIR.warnings。"""
        from uasset_read.ir_builder import build_package_ir
        from uasset_read.models.result import ParseResult
        from uasset_read.kismet.result import KismetDecompiledResult
        ...
        result = ParseResult()
        result.is_success = True
        result.summary = type("S", (), {"export_count": 0, "export_offset": 0, "import_count": 0, "import_offset": 0,
            "package_name": "/Test", "package_class": "None", "package_flags": 0, "ue_version": "5.0",
            "file_version_ue4": 0, "file_version_ue5": 0, "file_version_licensee": 0,
            "total_header_size": 0, "custom_versions": [], "folder_name": "",
            "name_count": 0, "name_offset": 0, "soft_object_paths_count": 0, "soft_object_paths_offset": 0,
        ...
        ir = build_package_ir(result)
        # 函数级 warning 应被聚合（去重后）
        assert any("unsupported expression" in w for w in ir.warnings)
