...
Plans:
- [ ] 35d-01-PLAN.md — property_types.py 数组大小/Map类型提取/条目计数验证 (CR-09, MED-01, 35c-06)
- [ ] 35d-02-PLAN.md — variable_extractor.py 标志映射 + blueprint.py 去重 (CR-11, LOW-04)
- [ ] 35d-03-PLAN.md — models/properties.py 模型字段默认值 (CR-13)
- [ ] 35d-04-PLAN.md — json_formatter.py 递归序列化 + markdown 转义 + transform KeyError (CR-14/15, HIGH-17, HIGH-09)
- [ ] 35d-05-PLAN.md — flow_builder.py 安全迭代 + node_guid 检查 (LOW-06/07)
- [ ] 35d-06-PLAN.md — 重复常量/死代码/重复函数清理 (MED-14, HIGH-08)
