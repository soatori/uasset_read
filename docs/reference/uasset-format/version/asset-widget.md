...
| 版本号 | 说明 |
|--------|------|
| VER_UE4_UMG_STYLE_ASSETS_REFACTOR | UMG 样式资产重构 |
| VER_UE4_UMG_NEW_BINDING_SYSTEM | 新 Binding 系统引入 |
...
| 版本号 | 说明 | 源码位置 |
|--------|------|----------|
| VER_UE4_UMG_STYLE_ASSETS_REFACTOR | UMG 样式资产重构 | ObjectVersion.h |
| VER_UE4_UMG_NEW_BINDING_SYSTEM | 新 Binding 系统 | ObjectVersion.h |
| VER_UE4_UMG_PURGE_LAYOUTTREE_ON_DETACH | LayoutTree 清理 | ObjectVersion.h |

### UE5 CustomVersion

| 版本号 | 说明 |
|--------|------|
| PROPERTY_TAG_COMPLETE_TYPE_NAME | 属性标签类型名系统（Binding 序列化影响） |
| PROPERTY_TAG_EXTENSION_AND_OVERRIDABLE_SERIALIZATION | 属性扩展机制 |
