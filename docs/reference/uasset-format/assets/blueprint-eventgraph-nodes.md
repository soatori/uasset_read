...
| 字段 | 说明 |
|------|------|
| EventReference.MemberParent | 事件来源类 |
| EventReference.MemberName | 事件函数名 |
| bOverrideFunction | 是否覆盖父类实现 |
...
| PinName | Direction | PinType | 说明 |
|---------|-----------|---------|------|
| OutputDelegate | Output | delegate | 事件委托输出 |
...
| 字段 | 说明 |
|------|------|
| FunctionReference.MemberName | 函数名 |
| bIsEditable | 是否在编辑器中可编辑 |
| ExtraFlags | 额外标志 |
...
| 文件 | 说明 |
|------|------|
| Runtime/BlueprintGraph/Classes/K2Node_CallFunction.h | K2Node_CallFunction 定义 |
| Runtime/BlueprintGraph/Classes/K2Node_Event.h | K2Node_Event 定义 |
| Runtime/InputBlueprintNodes/Classes/K2Node_EnhancedInputAction.h | 增强输入节点 |
| Runtime/UnrealEd/Classes/EdGraphNode_Comment.h | 注释节点 |
| Runtime/BlueprintGraph/Classes/K2Node_FunctionEntry.h | 函数入口 |
| Runtime/BlueprintGraph/Classes/K2Node_Knot.h | 节点转接 |
...
*Source: UE5 Engine Source, BlueprintGraph, InputBlueprintNodes Modules*
*Phase: 05-蓝图与动画资产*
