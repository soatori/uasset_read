...
| PinType.PinSubCategoryObject | FPackageIndex | 子类别对象（结构体/类路径） |
...
| 文件 | 说明 |
|------|------|
| Runtime/BlueprintGraph/Classes/K2Node_FunctionEntry.h | 函数入口节点 |
| Runtime/BlueprintGraph/Private/K2Node_FunctionEntry.cpp | 编译器实现 |
...
*Source: UE5 Engine Source, BlueprintGraph Module*
*Phase: 05-蓝图与动画资产*
