...
说明：ImportedMaterialSlotName 用于材质重映射，确保重新导入时材质槽顺序正确。
...
│   ├── [0] FStaticMaterial → MaterialInterface, MaterialSlotName
│   ├── [1] FStaticMaterial → ...
│   └── ...
├── RenderData
│   └── LODResources[0]
...
- Runtime/Engine/Classes/Engine/StaticMesh.h — FStaticMaterial 定义、FStaticMeshSection 定义
