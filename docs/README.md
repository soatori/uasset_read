...
uasset_read 项目文档分为以下几个部分：

## 用户指南

| 文档 | 说明 |
|------|------|
| [快速开始](GETTING-STARTED.md) | 安装、CLI 使用、API 调用示例 |
| [配置](CONFIGURATION.md) | CLI 参数和 API 配置选项 |
| [CONTRIBUTING](CONTRIBUTING.md) | 开发环境、编码规范、测试要求、PR 流程 |

## 开发者文档

| 文档 | 说明 |
|------|------|
| [架构设计](ARCHITECTURE.md) | 系统架构、模块职责、数据流 |
| [开发指南](DEVELOPMENT.md) | 开发工作流、GSD 工作模式 |
