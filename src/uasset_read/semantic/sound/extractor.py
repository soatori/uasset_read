...
_WAVE_RESOURCE_KEYS = ("duration", "sample_rate", "channel_count", "format",
                       "compression_quality", "sound_group", "loading_behavior")
...
_ATTEN_KEYS = ("attenuation_shape", "attenuation_radius", "falloff_function",
               "spatialization_algorithm", "battenuate_over_distance",
               "battenuate_over_time", "distance_algorithm")
