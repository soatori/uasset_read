"""导出条目属性循环及 unversioned 属性解析。

从 property_parser.py 拆分 — 包含 parse_properties_from_export 及其
所有 unversioned 映射驱动的辅助函数。
"""
...
def parse_properties_from_export(
    ...
    """
    # 延迟导入避免循环依赖
    from uasset_read.parsers.property_parser import parse_property_value, _try_asset_type_handler
