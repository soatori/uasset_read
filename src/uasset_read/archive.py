...
class FArchive:
    ...
    def validate_size(
        self, size: int, context: str = "", tolerant: bool | None = None, property_type: str | None = None
    ) -> bool:
    ...
    def read_name(self, name_map: Optional[list] = None, key: str = "") -> str:
        ...
        if name_map is None:
            ...
            if name_map is None:
                raise ParseError("read_name() requires name_map argument or call set_name_map() to set internal cache")
...
# ============================================================================
# Source abstraction — addressable byte regions (v2 merge)
# ============================================================================
